...
public class Quicksort {
	...
	public static void main(String[] args) {
		...
		if (args.length != 3) {
			System.out
					.println("Wrong number of command line args, " + "please pass 2 files and the numbers of buffers");
		}
		if (Integer.valueOf(args[1]).intValue() > 20 && Integer.valueOf(args[1]).intValue() < 1) {
			System.out.println("Wrong number of buffers, " + "please input an integer between 1 and 20");
		}
	 ...
	 * 
	 * @param bp    bufferpool object which stores the file's data
	 * @param begin first index of the unsorted portion of array
	 * @param end   last index of the unsorted portion of array
	 ...
	 * @throws IOException throws upon failure to acquire or write i/o sufficiently
	 */
	private static int partition(BufferPool bp, int begin, int end) throws IOException {
